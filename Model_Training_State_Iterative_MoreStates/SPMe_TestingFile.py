...
if __name__ == '__main__':
    ...
    # model = DDPG(MlpPolicy, env, action_noise=action_noise, verbose=1, train_freq=2500, n_episodes_rollout=-1)
    model = DDPG(MlpPolicy, env, verbose=1, train_freq=25000, n_episodes_rollout=-1)
