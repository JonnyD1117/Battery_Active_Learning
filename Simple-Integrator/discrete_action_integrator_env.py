...
class DiscreteSimpleSOC(gym.Env):
    ...
    def __init__(self, log_state=True):
        ...
        if self.log_state is True:
            self.writer = SummaryWriter('./Temp_Logs/Round2/DiscreteT0_with_penalty_SOC_range_point65_point85_uniformedExtended')
    ...
    def step(self, action):
        ...
        if self.log_state is True:
            ...
            self.writer.add_scalar('SimpleSOC/Cum. Reward', self.tb_reward_mean, self.global_counter)
