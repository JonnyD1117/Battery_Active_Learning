...
# Load FUDs input Profile from .MAT file
# NOTE: From prior knowledge "time_step" = .2seconds
...
for t in range(0, len(time)):
    ...
    states, reward, done, info = custom_gym.step(I_fuds[t])
